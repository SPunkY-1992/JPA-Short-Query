...
public interface IsEquals {
  ...
  /**
   * example of usage: isEquals(System_.id, 1L), isEquals(System_.parent, null)
   */
  ...
  /**
   * example of usage: isEquals(User_.projects, Project_.subProjects, SubProject_.id, subProjectId)
   */
  default <S extends T, T,
